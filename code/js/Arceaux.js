...
function placerArceau(MaScene, vecteurTranslationArceau, coulArceau, rayonCyl, hauteurCyl, hauteurCylSol,largeurCylSol,hauteurCylHorizontal,hauteurLathe1Tore,largeurLatheTore, nbePtCbe, nbeptsRot, opacitePhong, brillancePhong, coulEmissivePhong , coulSpeculPhong) {
    ...
    let P2 = new THREE.Vector2(rayonCyl + largeurCylSol/2, 0);
    let P3 = new THREE.Vector2(rayonCyl + largeurCylSol, 0);
    ...
    let rayonMineur = rayonCyl / 3

    P0 = new THREE.Vector2(rayonMineur, hauteurLathe1Tore);
    P1 = new THREE.Vector2(rayonMineur, hauteurLathe1Tore / 4);
    P2 = new THREE.Vector2(rayonMineur + largeurLatheTore/2, 0);
    P3 = new THREE.Vector2(rayonMineur + largeurLatheTore, 0);
...
function ajoutArceauGui(gui,menuGUI,MaScene,arceau1,arceau2,arceau3,positionArceau1,positionArceau2,positionArceau3,coulArceau,hauteurCylHorizontal) {
    ...
    guiArceau.add(menuGUI, "hauteurLathe1", 0.01, 0.2).onChange(function () {
        retirerArceaux();
        placerArceauxGUI();
    });
    guiArceau.add(menuGUI, "largeurLathe1", 0.01, 0.2).onChange(function () {
        retirerArceaux();
        placerArceauxGUI();
    });
    guiArceau.add(menuGUI, "hauteurLathe2", 0.01, 0.2).onChange(function () {
        retirerArceaux();
        placerArceauxGUI();
    });
    guiArceau.add(menuGUI, "largeurLathe2", 0.01, 0.2).onChange(function () {
        retirerArceaux();
        placerArceauxGUI();
    });
    ...
    function placerArceauxGUI() {
        arceau1 = placerArceau(MaScene, positionArceau1, coulArceau, menuGUI.rayonCylindreBase, menuGUI.hauteurCylindreBase
            , menuGUI.hauteurLathe1, menuGUI.largeurLathe1, hauteurCylHorizontal, menuGUI.hauteurLathe2, menuGUI.largeurLathe2, menuGUI.nbPtsCourbe, menuGUI.nbPtsRotation
...
function placerArceauxAvecVerification(scene, variationY, toleranceAlignement,coulArceau, rayonCyl,
    ...
    let arceau1 = placerArceau(scene, positionArceau1, coulArceau, rayonCyl, hauteurCyl, hauteurCylSol,largeurCylSol,
    ...
    let arceau2 = placerArceau(scene, positionArceau2, coulArceau, rayonCyl, hauteurCyl, hauteurCylSol,largeurCylSol,
        hauteurCylHorizontal,hauteurLathe2,largeurLathe2, nbePtsCbe, nbPtsRot, opaciteArceauPhong, brillanceArceauPhong, coulEmissiveArceauPhong , coulSpecArceauPhong);

    let arceau3 = placerArceau(scene, positionArceau3, coulArceau, rayonCyl, hauteurCyl, hauteurCylSol,largeurCylSol,
        hauteurCylHorizontal,hauteurLathe2,largeurLathe2, nbePtsCbe, nbPtsRot, opaciteArceauPhong, brillanceArceauPhong, coulEmissiveArceauPhong , coulSpecArceauPhong);
